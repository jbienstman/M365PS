Function FunctionConnectRestApiUsingCertificate {
    <#
    .SYNOPSIS
        This function will connect to a REST API using a "Certificate" and returns Headers for use with Invoke-RestMethod Token - requires: Scope, TenantId, ClientId & CertificateThumbprint
    .EXAMPLE
        $Headers = FunctionConnectRestApiUsingCertificate -Scope "https://graph.microsoft.com/.default" -TenantId 'GUID' -ClientId 'GUID' -CertificateThumbprint 'THUMBPRINT'
    .INPUTS
        string
    .OUTPUTS
        Hashtable
