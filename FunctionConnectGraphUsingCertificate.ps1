Function FunctionConnectGraphUsingCertificate {
    <#
    .SYNOPSIS
        This function will connect to GRAPH API scope using a "Certificate" and returns Headers for use with Invoke-RestMethod Token - requires: TenantId, ClientId & CertificateThumbprint
    .EXAMPLE
        $Headers = FunctionConnectGraphUsingCertificate -TenantId 'GUID' -ClientId 'GUID' -CertificateThumbprint 'THUMBPRINT'
    .INPUTS
        string
    .OUTPUTS
        Hashtable
